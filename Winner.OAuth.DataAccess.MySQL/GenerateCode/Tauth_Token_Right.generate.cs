 ...
 * CreateTime : 2018-07-27 15:04:17
...
namespace Winner.OAuth.DataAccess.MySQL
{
	...
	public partial class Tauth_Token_Right : DataAccessBase, ITauth_Token_Right
	{
		...
		public bool Insert()
		{		
			string sql = @"INSERT INTO tauth_token_right(TOKEN_ID,API_ID,LAST_MODIFY_TIME,HAVE_RIGHT,EXPIRE_TIME)
			VALUES (?TOKEN_ID,?API_ID,?LAST_MODIFY_TIME,?HAVE_RIGHT,?EXPIRE_TIME)";
