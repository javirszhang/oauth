...
* CreateTime : 2019-10-25 11:57:23
...
namespace Winner.OAuth.DataAccess.Oracle
{
    ...
    public partial class Tauth_App : DataAccessBase, ITauth_App
    {
        ...
        public const string _ALLOW_MULTI_LOGIN = "ALLOW_MULTI_LOGIN";
        public const string _TOKEN_EXPIRE_IN = "TOKEN_EXPIRE_IN";
        ...
        protected override DataRow BuildRow()
        {
            ...
            table.Columns.Add(_ALLOW_MULTI_LOGIN, typeof(int)).DefaultValue = 1;
            table.Columns.Add(_TOKEN_EXPIRE_IN, typeof(int)).DefaultValue = 3600;
            return table.NewRow();
        }
        #endregion
        ...
        /// <summary>
        /// 是否允许多终端同时登陆[0 - 不允许，1 - 允许](必填)
        /// <para>
        /// defaultValue: 1;   Length: 10Byte
        /// </para>
        /// </summary>
        public int Allow_Multi_Login
        {
            get { return Convert.ToInt32(DataRow[_ALLOW_MULTI_LOGIN]); }
            set { setProperty(_ALLOW_MULTI_LOGIN, value); }
        }
        /// <summary>
        /// 发放的token有效期，单位秒(必填)
        /// <para>
        /// defaultValue: 3600;   Length: 10Byte
        /// </para>
        /// </summary>
        public int Token_Expire_In
        {
            get { return Convert.ToInt32(DataRow[_TOKEN_EXPIRE_IN]); }
            set { setProperty(_TOKEN_EXPIRE_IN, value); }
        }
        #endregion
        ...
        {
            string sql = "SELECT APP_ID,APP_CODE,APP_NAME,APP_HOST,SECRET_KEY,UID_ENCRYPT_KEY,ACCESS_TOKEN,CREATE_TIME,REMARKS,STATUS,IS_INTERNAL,LOGO_URL,ALLOW_MULTI_LOGIN,TOKEN_EXPIRE_IN FROM TAUTH_APP WHERE " + condition;
        ...
        public bool Insert()
        {
            ...
            string sql = @"INSERT INTO TAUTH_APP(APP_ID,APP_CODE,APP_NAME,APP_HOST,SECRET_KEY,UID_ENCRYPT_KEY,ACCESS_TOKEN,REMARKS,STATUS,IS_INTERNAL,LOGO_URL,ALLOW_MULTI_LOGIN,TOKEN_EXPIRE_IN)
			VALUES (:APP_ID,:APP_CODE,:APP_NAME,:APP_HOST,:SECRET_KEY,:UID_ENCRYPT_KEY,:ACCESS_TOKEN,:REMARKS,:STATUS,:IS_INTERNAL,:LOGO_URL,:ALLOW_MULTI_LOGIN,:TOKEN_EXPIRE_IN)";
            AddParameter(_APP_ID, DataRow[_APP_ID]);
            ...
            AddParameter(_ALLOW_MULTI_LOGIN, DataRow[_ALLOW_MULTI_LOGIN]);
            AddParameter(_TOKEN_EXPIRE_IN, DataRow[_TOKEN_EXPIRE_IN]);
        ...
        public bool SelectByAppCode(string appcode)
        {
            string condition = $"{_APP_CODE}=:{_APP_CODE}";
            AddParameter(_APP_CODE, appcode);
            return SelectByCondition(condition);
        }
        #endregion
    }
