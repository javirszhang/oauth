...
namespace Winner.OAuth.DataAccess.Oracle
{
	...
	public partial class Tauth_Scope_Apis : DataAccessBase, ITauth_Scope_Apis
	{
		...
		public bool Insert()
		{		
			int id = this.Api_Id = GetSequence("SELECT SEQ_TAUTH_SCOPE_APIS.nextval FROM DUAL");
			string sql = @"INSERT INTO TAUTH_SCOPE_APIS(API_ID,SCOPE_ID,API_URL,API_NAME,STATUS)
			VALUES (:API_ID,:SCOPE_ID,:API_URL,:API_NAME,:STATUS)";
			AddParameter(_API_ID,DataRow[_API_ID]);
