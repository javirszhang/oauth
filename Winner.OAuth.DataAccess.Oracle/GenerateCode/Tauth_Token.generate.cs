...
namespace Winner.OAuth.DataAccess.Oracle
{
	...
	public partial class Tauth_Token : DataAccessBase,ITauth_Token
	{
		...
		{		
			...
			string sql = @"INSERT INTO TAUTH_TOKEN(TOKEN_ID,APP_ID,USER_ID,TOKEN_CODE,SCOPE_ID,EXPIRE_TIME,REFRESH_TOKEN,REFRESH_TIMEOUT,GRANT_ID,DEVICE_ID,LAST_ACCESS_TIME)
