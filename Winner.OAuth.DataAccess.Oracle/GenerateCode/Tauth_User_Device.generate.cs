 ...
 * CreateTime : 2019-01-10 11:19:23
...
namespace Winner.OAuth.DataAccess.Oracle
{
	...
	public partial class Tauth_User_Device : DataAccessBase,ITauth_User_Device
	{
		...
		public bool Insert()
		{		
			int id = this.Id = GetSequence("SELECT SEQ_TAUTH_USER_DEVICE.nextval FROM DUAL");
			string sql = @"INSERT INTO TAUTH_USER_DEVICE(ID,DEVICE_ID,USER_ID,DEVICE_MODEL,IS_AUTHORIZED,LAST_MODIFY_TIME,LAST_ACCESS_TIME)
			VALUES (:ID,:DEVICE_ID,:USER_ID,:DEVICE_MODEL,:IS_AUTHORIZED,:LAST_MODIFY_TIME,:LAST_ACCESS_TIME)";
			AddParameter(_ID,DataRow[_ID]);
