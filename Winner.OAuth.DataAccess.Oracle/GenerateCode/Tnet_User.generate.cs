...
namespace Winner.OAuth.DataAccess.Oracle
{
	...
	public partial class Tnet_User : DataAccessBase, ITnet_User
	{
		...
		{		
			...
			string sql = @"INSERT INTO TNET_USER(USER_ID,USER_NICKNAME,USER_NAME,FATHER_ID,USER_STATUS,USER_LEVEL,AUTH_STATUS,AUTH_TIME,PHOTO_URL,DATA_SOURCE,REMARKS)
			VALUES (:USER_ID,:USER_NICKNAME,:USER_NAME,:FATHER_ID,:USER_STATUS,:USER_LEVEL,:AUTH_STATUS,:AUTH_TIME,:PHOTO_URL,:DATA_SOURCE,:REMARKS)";
			AddParameter(_USER_ID,DataRow[_USER_ID]);
