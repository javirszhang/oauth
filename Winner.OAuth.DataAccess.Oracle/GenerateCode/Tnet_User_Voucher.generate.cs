 ...
 * CreateTime : 2018-07-27 15:07:55
...
namespace Winner.OAuth.DataAccess.Oracle
{
	...
	public partial class Tnet_User_Voucher : DataAccessBase, ITnet_User_Voucher
	{
		...
		protected override DataRow BuildRow()
		{
			...
			table.Columns.Add(_VOUCHER_ID,typeof(int)).DefaultValue=0;
		...
		public bool Insert()
		{		
			int id = this.Voucher_Id = GetSequence("SELECT SEQ_TNET_USER_VOUCHER.nextval FROM DUAL");
			string sql = @"INSERT INTO TNET_USER_VOUCHER(VOUCHER_ID,USER_ID,USER_CODE,VOUCHER_TYPE,ALLOW_LOGIN,IS_VALID,REMARKS,STATUS)
			VALUES (:VOUCHER_ID,:USER_ID,:USER_CODE,:VOUCHER_TYPE,:ALLOW_LOGIN,:IS_VALID,:REMARKS,:STATUS)";
			AddParameter(_VOUCHER_ID,DataRow[_VOUCHER_ID]);
